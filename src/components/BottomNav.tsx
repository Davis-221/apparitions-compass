...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 safe-area-bottom pointer-events-none">
      <div className="pointer-events-auto mx-auto mb-3 flex max-w-md items-center justify-between gap-1 rounded-full border border-white/15 bg-[oklch(0.22_0.08_265/0.75)] px-2 py-2 backdrop-blur-2xl shadow-[0_20px_60px_-20px_oklch(0_0_0/0.6)]"
            ...
            >
              {active && (
                <span
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, oklch(0.83 0.12 220), oklch(0.87 0.10 90))",
                    boxShadow:
                      "0 8px 24px -8px oklch(0.83 0.14 220 / 0.7), 0 0 0 1px oklch(1 0 0 / 0.15) inset",
                  }}
                />
              )}
